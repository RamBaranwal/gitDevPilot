          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                tooltip="Synapse"
              >
                <SynapseIcon className="size-8 rounded-[10px]" />
...
export function BrandMark({ className }: { className?: string }) {
  return (
    ...
    >
      <SynapseIcon className="size-8 rounded-[10px]" />
      <span className="font-heading text-[1.05rem] leading-none">Synapse</span>
    </div>
  );
}
...
export function GhostButtonLink({
  ...
  return (
    <Button variant="ghost" size="sm" className={className} nativeButton={false} render={<Link href={href} />}>
      {children}
    </Button>
  );
}
